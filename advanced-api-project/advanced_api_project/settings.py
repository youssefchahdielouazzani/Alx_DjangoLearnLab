...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Ajouter des dossiers templates si besoin
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',  # Base simple pour ALX
...
# Django REST Framework settings (optionnel pour ALX mais bon à ajouter)
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',  # Réponse JSON par défaut
    ],
